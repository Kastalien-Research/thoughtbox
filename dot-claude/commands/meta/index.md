...
### [output-gap-analysis](./output-gap-analysis.md)

Systematically evaluate any summarized output to identify what's useful, what's missing, and how to improve the summarization process. Uses Thoughtbox for structured evaluation.
