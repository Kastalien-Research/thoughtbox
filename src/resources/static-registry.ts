...
export const STATIC_RESOURCES: StaticResourceDef[] = [
  ...
  },
  {
    ...
    description: "Complete catalog of operations available through the Code Mode gateway, grouped by tb SDK module (thought, session, knowledge, notebook, theseus, ulysses, observability, branch, hub, claims)",
    mimeType: "application/json",
  },
  {
