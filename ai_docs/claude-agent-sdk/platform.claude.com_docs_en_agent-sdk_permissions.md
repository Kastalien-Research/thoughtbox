...
title: "Handling Permissions - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fagent-sdk%2Fpermissions)
...
- [Overview](https://platform.claude.com/docs/en/agent-sdk/permissions#overview)
- [Permission Flow Diagram](https://platform.claude.com/docs/en/agent-sdk/permissions#permission-flow-diagram)
...
- [Setting Permission Mode](https://platform.claude.com/docs/en/agent-sdk/permissions#setting-permission-mode)
- [Mode-Specific Behaviors](https://platform.claude.com/docs/en/agent-sdk/permissions#mode-specific-behaviors)
- [Mode Priority in Permission Flow](https://platform.claude.com/docs/en/agent-sdk/permissions#mode-priority-in-permission-flow)
- [Best Practices](https://platform.claude.com/docs/en/agent-sdk/permissions#best-practices)
- [canUseTool](https://platform.claude.com/docs/en/agent-sdk/permissions#can-use-tool)
