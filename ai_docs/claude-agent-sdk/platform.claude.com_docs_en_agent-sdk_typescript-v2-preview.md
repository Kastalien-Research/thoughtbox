...
title: "TypeScript SDK V2 interface (preview) - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fagent-sdk%2Ftypescript-v2-preview)
...
- [unstable\_v2\_createSession()](https://platform.claude.com/docs/en/agent-sdk/typescript-v2-preview#unstable-v2-create-session)
- [unstable\_v2\_resumeSession()](https://platform.claude.com/docs/en/agent-sdk/typescript-v2-preview#unstable-v2-resume-session)
- [unstable\_v2\_prompt()](https://platform.claude.com/docs/en/agent-sdk/typescript-v2-preview#unstable-v2-prompt)
- [Session interface](https://platform.claude.com/docs/en/agent-sdk/typescript-v2-preview#session-interface)
