...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fagent-sdk%2Fsubagents)
...
- [How the SDK Uses Subagents](https://platform.claude.com/docs/en/agent-sdk/subagents#how-the-sdk-uses-subagents)
- [Example Subagents](https://platform.claude.com/docs/en/agent-sdk/subagents#example-subagents)
- [SDK Integration Patterns](https://platform.claude.com/docs/en/agent-sdk/subagents#sdk-integration-patterns)
