...
title: "Custom Tools - Claude Docs"
---
...
[Log in](https://platform.claude.com/login?returnTo=%2Fdocs%2Fen%2Fagent-sdk%2Fcustom-tools)
...
- [Creating Custom Tools](https://platform.claude.com/docs/en/agent-sdk/custom-tools#creating-custom-tools)
- [Using Custom Tools](https://platform.claude.com/docs/en/agent-sdk/custom-tools#using-custom-tools)
- [Tool Name Format](https://platform.claude.com/docs/en/agent-sdk/custom-tools#tool-name-format)
- [Configuring Allowed Tools](https://platform.claude.com/docs/en/agent-sdk/custom-tools#configuring-allowed-tools)
- [Multiple Tools Example](https://platform.claude.com/docs/en/agent-sdk/custom-tools#multiple-tools-example)
- [Type Safety with Python](https://platform.claude.com/docs/en/agent-sdk/custom-tools#type-safety-with-python)
- [Error Handling](https://platform.claude.com/docs/en/agent-sdk/custom-tools#error-handling)
- [Example Tools](https://platform.claude.com/docs/en/agent-sdk/custom-tools#example-tools)
- [Database Query Tool](https://platform.claude.com/docs/en/agent-sdk/custom-tools#database-query-tool)
- [API Gateway Tool](https://platform.claude.com/docs/en/agent-sdk/custom-tools#api-gateway-tool)
- [Calculator Tool](https://platform.claude.com/docs/en/agent-sdk/custom-tools#calculator-tool)
- [Related Documentation](https://platform.claude.com/docs/en/agent-sdk/custom-tools#related-documentation)
